...
//Fonksiyon icerisinde uretilip fonksiyon islemleri bittiginde RAM'den temizlenmesi icin
  ...
  public static void TelefonDogrula(String tlfno) {
	  ...
	  numaram.numaraGoster();
	  	...
	  	if(numaram.getTlfNo()==null) {
	  		System.out.println("Hatali veya eksik numara girisi yaptiniz. Lütfen düzeltiniz.");
	  	}
	  	else {
